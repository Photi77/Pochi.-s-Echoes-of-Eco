...
import net.pochi.pochimod.block.custom.fruits.PlumBlock;

public class PlumLeavesBlock extends LeavesBlock implements BonemealableBlock {
    public PlumLeavesBlock(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void performBonemeal(ServerLevel pLevel, RandomSource pRandom, BlockPos pPos, BlockState pState) {
        pLevel.setBlock(pPos.below(), PlumBlock.createNewHangingPropagule(),2);
    }
}
