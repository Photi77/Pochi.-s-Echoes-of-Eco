...
public class PamukaleLakeFeature extends Feature<PamukaleLakeFeature.Configuration> {
    private static final BlockState AIR = Blocks.CAVE_AIR.defaultBlockState();

    public PamukaleLakeFeature(Codec<PamukaleLakeFeature.Configuration> p_66259_) {
        super(p_66259_);
    }

    public boolean place(FeaturePlaceContext<PamukaleLakeFeature.Configuration> p_159958_) {
    ...
    public static record Configuration(BlockStateProvider fluid, BlockStateProvider barrier) implements FeatureConfiguration {
        public static final Codec<PamukaleLakeFeature.Configuration> CODEC = RecordCodecBuilder.create((p_190962_) -> {
            return p_190962_.group(BlockStateProvider.CODEC.fieldOf("fluid").forGetter(PamukaleLakeFeature.Configuration::fluid), BlockStateProvider.CODEC.fieldOf("barrier").forGetter(PamukaleLakeFeature.Configuration::barrier)).apply(p_190962_, PamukaleLakeFeature.Configuration::new);
        });
    }
}