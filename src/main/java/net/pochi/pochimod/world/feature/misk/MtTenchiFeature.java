...
public class MtTenchiFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public MtTenchiFeature(Codec<NoneFeatureConfiguration> configCodec) {
        super(configCodec);
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        // 高台のベース高さと変動範囲
        int startHeight = 0;
        int baseHeight = 120;                    // ベースとなる高さ
        int maxHeightVariation = 10;             // 最大高さの変動
        int maxRadius = 9;                      // 麓の最大半径
        int topRadius = 4;                       // 頂上の半径
