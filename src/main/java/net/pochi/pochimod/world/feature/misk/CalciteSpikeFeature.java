...
public class CalciteSpikeFeature extends Feature<NoneFeatureConfiguration> {
    public CalciteSpikeFeature(Codec<NoneFeatureConfiguration> p_66003_) {
        super(p_66003_);
    }
                ...
                for(int i1 = -l; i1 <= l; ++i1) {
                    ...
                    for(int j1 = -l; j1 <= l; ++j1) {
                        ...
                        if ((i1 == 0 && j1 == 0 || !(f1 * f1 + f2 * f2 > f * f)) && (i1 != -l && i1 != l && j1 != -l && j1 != l || !(randomsource.nextFloat() > 0.75F))) {
                            ...
                            if (blockstate.isAir() || isDirt(blockstate) || blockstate.is(Blocks.CALCITE)) {
                                this.setBlock(worldgenlevel, blockpos.offset(i1, k, j1), Blocks.CALCITE.defaultBlockState());
                            }
            ...
            for(int l1 = -k1; l1 <= k1; ++l1) {
                for(int i2 = -k1; i2 <= k1; ++i2) {
                    ...
                    while(blockpos1.getY() > 50) {
                        ...
                        this.setBlock(worldgenlevel, blockpos1, Blocks.CALCITE.defaultBlockState());
