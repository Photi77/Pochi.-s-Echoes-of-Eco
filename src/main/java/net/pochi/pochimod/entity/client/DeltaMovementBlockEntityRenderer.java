...
public class DeltaMovementBlockEntityRenderer extends EntityRenderer<DeltaMovementBlockEntity> {
    ...
    public void render(DeltaMovementBlockEntity p_114634_, float p_114635_, float p_114636_, PoseStack p_114637_, MultiBufferSource p_114638_, int p_114639_) {
        ...
        if (blockstate.getRenderShape() == RenderShape.MODEL) {
            ...
            if (blockstate != level.getBlockState(p_114634_.blockPosition()) && blockstate.getRenderShape() != RenderShape.INVISIBLE) {
                ...
                for (var renderType : model.getRenderTypes(blockstate, RandomSource.create(blockstate.getSeed(p_114634_.getStartPos())), net.neoforged.neoforge.client.model.data.ModelData.EMPTY))
                    this.dispatcher.getModelRenderer().tesselateBlock(level, model, blockstate, blockpos, p_114637_, p_114638_.getBuffer(renderType), false, RandomSource.create(), blockstate.getSeed(p_114634_.getStartPos()), OverlayTexture.NO_OVERLAY, net.neoforged.neoforge.client.model.data.ModelData.EMPTY, renderType);
                p_114637_.popPose();
    ...
    public ResourceLocation getTextureLocation(DeltaMovementBlockEntity p_114632_) {
