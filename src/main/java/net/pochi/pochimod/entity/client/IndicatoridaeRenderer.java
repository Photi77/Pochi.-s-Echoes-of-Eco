...
public class IndicatoridaeRenderer extends MobRenderer<Indicatoridae, LivingEntityRenderState, IndicatoridaeModel> {

    private static final Identifier HERMIT_CRAB_LOCATION = Identifier.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/indicator.png");
