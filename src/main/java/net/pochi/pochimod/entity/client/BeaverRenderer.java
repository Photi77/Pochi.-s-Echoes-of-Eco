...
public class BeaverRenderer extends MobRenderer<Beaver, LivingEntityRenderState, BeaverModel> {

    private static final Identifier HERMIT_CRAB_LOCATION = Identifier.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/beaver.png");
