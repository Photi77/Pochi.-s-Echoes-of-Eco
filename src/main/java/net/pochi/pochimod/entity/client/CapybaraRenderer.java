...
public class CapybaraRenderer extends MobRenderer<Capybara, LivingEntityRenderState, CapybaraModel> {

    private static final Identifier TEXTURE_LOCATION = Identifier.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/capybara.png");
