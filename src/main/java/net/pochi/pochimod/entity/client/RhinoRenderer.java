...
public class RhinoRenderer extends MobRenderer<Rhino, LivingEntityRenderState, RhinoModel> {

    private static final Identifier TEXTURE_LOCATION = Identifier.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/rhino.png");
