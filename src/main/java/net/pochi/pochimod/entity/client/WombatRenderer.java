...
public class WombatRenderer extends MobRenderer<Wombat, LivingEntityRenderState, WombatModel> {
    private static final Identifier HERMIT_CRAB_LOCATION = Identifier.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/wombat.png");
