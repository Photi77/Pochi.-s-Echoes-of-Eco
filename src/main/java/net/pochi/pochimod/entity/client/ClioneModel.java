...
public class ClioneModel<T extends Clione> extends HierarchicalModel<T> {
	...
	public ClioneModel(ModelPart root) {
	...
	@Override
	public void setupAnim(Clione entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
