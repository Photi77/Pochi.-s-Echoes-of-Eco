...
public class SootyShearwaterRenderer extends MobRenderer<SootyShearwater, LivingEntityRenderState, SootyShearwaterModel> {

    private static final Identifier TEXTURE_LOCATION = Identifier.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/sooty_shearwater.png");
