...
public class SturgeonRenderer extends MobRenderer<Sturgeon, SturgeonModel<Sturgeon>> {
    ...
    private static final ResourceLocation HERMIT_CRAB_LOCATION = ResourceLocation.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/sturgeon.png");
    ...
    @Override
    public void render(Sturgeon pEntity, float pEntityYaw, float pPartialTicks,
    ...
    @Override
    public ResourceLocation getTextureLocation(Sturgeon pEntity) {
