...
public class RockPenguinRenderer extends MobRenderer<RockPenguin, LivingEntityRenderState, RockPenguinModel> {

    private static final Identifier HERMIT_CRAB_LOCATION = Identifier.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/penguin.png");
