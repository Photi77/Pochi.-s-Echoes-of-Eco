...
public class PorcupineModel extends EntityModel<LivingEntityRenderState> {
    ...
    public PorcupineModel(ModelPart root) {
        super(root.getChild("hystricidae"));
    ...
    public void setupAnim(LivingEntityRenderState state) {
        ...
        if((state.walkAnimationSpeed > 0.01F)){
            ModAnimationDefinitions.PORCUPINE_WALK.bake(this.root()).applyWalk(state.walkAnimationPos, state.walkAnimationSpeed, 2f, 2.5f);
        } else {
