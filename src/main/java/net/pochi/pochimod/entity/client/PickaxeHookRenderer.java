...
public class PickaxeHookRenderer extends EntityRenderer<PickaxeHook> {
    ...
    public void render(PickaxeHook p_114705_, float p_114706_, float p_114707_, PoseStack p_114708_, MultiBufferSource p_114709_, int p_114710_) {
        ...
        if (player != null) {
            ...
            vertex(vertexconsumer, matrix4f, posestack$pose, p_114710_, 0.0F, 0, 0, 1);
            vertex(vertexconsumer, matrix4f, posestack$pose, p_114710_, 1.0F, 0, 1, 1);
            vertex(vertexconsumer, matrix4f, posestack$pose, p_114710_, 1.0F, 1, 1, 0);
            vertex(vertexconsumer, matrix4f, posestack$pose, p_114710_, 0.0F, 1, 0, 0);
            p_114708_.popPose();
    ...
    private static void vertex(VertexConsumer p_254464_, Matrix4f p_254085_, PoseStack.Pose p_253962_, int p_254296_, float p_253632_, int p_254132_, int p_254171_, int p_254026_) {
        p_254464_.addVertex(p_254085_, p_253632_ - 0.5F, (float) p_254132_ - 0.5F, 0.0F).setColor(255, 255, 255, 255).setUv((float) p_254171_, (float) p_254026_).setOverlay(OverlayTexture.NO_OVERLAY).setLight(p_254296_).setNormal(p_253962_, 0.0F, 1.0F, 0.0F);
    }
