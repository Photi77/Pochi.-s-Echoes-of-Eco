...
public class TapirRenderer extends MobRenderer<Tapir, TapirModel<Tapir>> {
    ...
    private static final ResourceLocation HERMIT_CRAB_LOCATION = ResourceLocation.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/tapir.png");
    ...
    @Override
    public void render(Tapir pEntity, float pEntityYaw, float pPartialTicks,
    ...
    @Override
    public ResourceLocation getTextureLocation(Tapir pEntity) {
