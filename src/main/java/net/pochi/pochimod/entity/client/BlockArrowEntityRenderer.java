...
public class BlockArrowEntityRenderer extends EntityRenderer<BlockArrowEntity> {
    ...
    public void render(BlockArrowEntity p_114634_, float p_114635_, float p_114636_, PoseStack p_114637_, MultiBufferSource p_114638_, int p_114639_) {
    ...
    public ResourceLocation getTextureLocation(BlockArrowEntity p_114632_) {
