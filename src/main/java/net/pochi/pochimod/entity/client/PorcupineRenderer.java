...
public class PorcupineRenderer extends MobRenderer<Porcupine, LivingEntityRenderState, PorcupineModel> {

    private static final Identifier HERMIT_CRAB_LOCATION = Identifier.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/porcupine.png");
