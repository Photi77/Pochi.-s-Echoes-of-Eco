...
public class PerissoRenderer extends MobRenderer<Perisso, LivingEntityRenderState, PerissoModel> {

    private static final Identifier HERMIT_CRAB_LOCATION = Identifier.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/perisso.png");
