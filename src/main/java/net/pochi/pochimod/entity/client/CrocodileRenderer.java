...
public class CrocodileRenderer extends MobRenderer<Crocodile, LivingEntityRenderState, CrocodileModel> {

    private static final Identifier TEXTURE_LOCATION = Identifier.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/crocodile.png");
