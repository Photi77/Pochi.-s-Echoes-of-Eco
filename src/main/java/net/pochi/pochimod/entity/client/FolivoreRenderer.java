...
public class FolivoreRenderer extends MobRenderer<Folivore, LivingEntityRenderState, FolivoreModel> {

    private static final Identifier HERMIT_CRAB_LOCATION = Identifier.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/folivore.png");
