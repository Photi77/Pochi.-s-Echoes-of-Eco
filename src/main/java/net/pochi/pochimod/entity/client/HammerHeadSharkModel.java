...
public class HammerHeadSharkModel extends EntityModel<LivingEntityRenderState> {
    ...
    public void setupAnim(LivingEntityRenderState state) {
        ...
        ModAnimationDefinitions.HAMMER_HEAD_SWIM.bake(this.root()).applyWalk(state.walkAnimationPos, state.walkAnimationSpeed, 2f, 2.5f);
    }
