...
public class WoodPeckerModel extends EntityModel<LivingEntityRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition face = all.addOrReplaceChild("face", CubeListBuilder.create().texOffs(14, 30).addBox(-1.0F, -5.0F, -3.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.01F))
                .texOffs(34, 33).addBox(-1.5F, -5.0F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(26, 35).addBox(0.5F, -5.0F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(34, 30).addBox(-1.0F, -6.0F, -2.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.0F, -2.0F));

        PartDefinition cube_r1 = face.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(34, 0).addBox(-1.0F, -8.0F, -7.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 3.5F, 2.0F, 0.0873F, 0.0F, 0.0F));
        ...
        PartDefinition rightleg = all.addOrReplaceChild("rightleg", CubeListBuilder.create().texOffs(22, 9).addBox(-1.0F, 2.0F, -1.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(4, 36).addBox(-1.0F, -1.0F, 0.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, -2.0F, 0.0F));
        ...
        PartDefinition cube_r6 = rightwing.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(32, 13).addBox(-1.0F, 0.0F, 4.0F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(34, 4).addBox(-1.0F, 3.0F, 0.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition leftleg = all.addOrReplaceChild("leftleg", CubeListBuilder.create().texOffs(0, 36).addBox(0.0F, -1.0F, 0.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
    ...
    public void setupAnim(LivingEntityRenderState state) {
        ...
        if(state.walkAnimationSpeed <= 0.01F) {
            if((state.walkAnimationSpeed > 0.01F)) {
                ModAnimationDefinitions.WOODPECKER_WALK.bake(this.root()).applyWalk(state.walkAnimationPos, state.walkAnimationSpeed, 2f, 2.5f);
            }
        } else {
            ModAnimationDefinitions.WOODPECKER_FLY.bake(this.root()).applyWalk(state.walkAnimationPos, state.walkAnimationSpeed, 2f, 2.5f);
        }
    }
