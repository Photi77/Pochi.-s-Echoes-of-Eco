...
public class LeafySeaDragonRenderer extends MobRenderer<LeafySeaDragon, LeafySeaDragonModel<LeafySeaDragon>> {
    ...
    private static final ResourceLocation HERMIT_CRAB_LOCATION = ResourceLocation.fromNamespaceAndPath(PochiMod.MOD_ID, "textures/entity/leafyseadragon.png");
    ...
    @Override
    public void render(LeafySeaDragon pEntity, float pEntityYaw, float pPartialTicks,
    ...
    @Override
    public ResourceLocation getTextureLocation(LeafySeaDragon pEntity) {
