...
public class Peacock extends Animal implements FlyingAnimal {
    ...
    public Peacock(EntityType<? extends Animal> entityType, Level level) {
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide && this.isAlive() && !this.isBaby() && --this.eggTime <= 0) {
            ...
            this.eggTime = 600;
            ExperienceOrb.award((ServerLevel) this.level(), this.position(), this.random.nextInt(3000));
        }
    }
