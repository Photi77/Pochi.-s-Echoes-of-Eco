...
public class GoblinShark extends AgeableaterAnimal {

    public int eggTime = this.random.nextInt(6000) + 600;
    private static final EntityDataAccessor<Integer> MOISTNESS_LEVEL = SynchedEntityData.defineId(GoblinShark.class, EntityDataSerializers.INT);
    ...
    public GoblinShark(EntityType<? extends AgeableaterAnimal> p_30341_, Level p_30342_) {
