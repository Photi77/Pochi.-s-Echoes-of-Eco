...
public class FruitFly extends Bee {
    ...
    protected void registerGoals() {
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, Player.class, 5, false, false, (p_28879_, sLevel) -> p_28879_.hasEffect(ModEffects.DROWNED)));
        super.registerGoals();
    }

    public boolean doHurtTarget(net.minecraft.server.level.ServerLevel pLevel, net.minecraft.world.entity.Entity p_27722_) {
        boolean flag = false; p_27722_.hurt(this.damageSources().sting(this), (float)((int)this.getAttributeValue(Attributes.ATTACK_DAMAGE)));
        if (flag) {
