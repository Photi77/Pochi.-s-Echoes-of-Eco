...
public class SecretaryBird extends Animal implements FlyingAnimal {
    ...
    public SecretaryBird(EntityType<? extends Animal> entityType, Level level) {
    ...
    public static AttributeSupplier setAttributes() {
        return Animal.createAnimalAttributes()
                ...
                .add(Attributes.FLYING_SPEED, (double)7.0F)
