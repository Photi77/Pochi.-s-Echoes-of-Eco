...
public class LeafySeaDragon extends AgeableaterAnimal {
    private static final EntityDataAccessor<Integer> MOISTNESS_LEVEL = SynchedEntityData.defineId(LeafySeaDragon.class, EntityDataSerializers.INT);
    ...
    public LeafySeaDragon(EntityType<? extends AgeableaterAnimal> p_30341_, Level p_30342_) {
        super(p_30341_, p_30342_);
        this.moveControl = new SmoothSwimmingMoveControl(this, 85, 10, 0.02F, 0.1F, true);
        this.lookControl = new SmoothSwimmingLookControl(this, 10);
    }

    public static boolean checkWaterSpawnRules(EntityType<LeafySeaDragon> p_218277_, LevelAccessor p_218278_, EntitySpawnReason p_218279_, BlockPos p_218280_, RandomSource p_218281_) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_146743_, AgeableMob p_146744_) {
        return ModEntityTypes.LEAFY_SEA.get().create(p_146743_, net.minecraft.world.entity.EntitySpawnReason.MOB_SUMMONED);
    }
