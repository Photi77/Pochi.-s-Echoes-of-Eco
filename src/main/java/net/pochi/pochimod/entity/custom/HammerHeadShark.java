...
public class HammerHeadShark extends AgeableaterAnimal {
    ...
    public static boolean checkWaterSpawnRules(EntityType<HammerHeadShark> p_218277_, LevelAccessor p_218278_, MobSpawnType p_218279_, BlockPos p_218280_, RandomSource p_218281_) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_146743_, AgeableMob p_146744_) {
        return ModEntityTypes.HAMMER_HEAD.get().create(p_146743_);
    }
