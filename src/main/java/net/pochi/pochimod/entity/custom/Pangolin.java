...
public class Pangolin extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new Pangolin.DolphinSwimWithPlayerGoal(this, 1.0D));
    ...
    public Pangolin(EntityType<? extends Animal> p_27557_, Level p_27558_) {
...
//
    ...
    static class DolphinSwimWithPlayerGoal extends Goal {
        private final Pangolin dolphin;
        private final double speedModifier;
        @javax.annotation.Nullable
        private Player player;

        DolphinSwimWithPlayerGoal(Pangolin p_28413_, double p_28414_) {
        ...
        public void start() {
            this.player.addEffect(new MobEffectInstance(ModEffects.SHIELD, 100), this.dolphin);
        }
