...
public class PallasCat extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new PallasCat.DolphinSwimWithPlayerGoal(this, 1.0D));
    ...
    public PallasCat(EntityType<? extends Animal> p_27557_, Level p_27558_) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_146743_, AgeableMob p_146744_) {
        return ModEntityTypes.PALLAS_CAT.get().create(p_146743_);
    }
    ...
    static class DolphinSwimWithPlayerGoal extends Goal {
        private final PallasCat dolphin;
        private final double speedModifier;
        @javax.annotation.Nullable
        private Player player;

        DolphinSwimWithPlayerGoal(PallasCat p_28413_, double p_28414_) {
        ...
        public boolean canUse() {
            this.player = this.dolphin.level().getNearestPlayer(PallasCat.SWIM_WITH_PLAYER_TARGETING, this.dolphin);
            if (this.player == null) {
                return false;
            } else {
        ...
        public void start() {
            this.player.addEffect(new MobEffectInstance(ModEffects.SNOW_WALK, 100), this.dolphin);
        }
