...
public class MiniHipo extends Animal {

    private static final Ingredient FOOD_ITEMS = Ingredient.of(Items.PUMPKIN, Items.MELON_SLICE,Items.WHEAT, ModItems.CABBAGE_LEAF.get());
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new MiniHipo.DeerStrippedGoal(1.0F,12,4));
    ...
    public MiniHipo(EntityType<? extends Animal> p_27557_, Level p_27558_) {
    ...
    public boolean isFood(ItemStack p_27600_) {
        return p_27600_.is(Items.MELON_SLICE);
    }
    ...
    public class DeerStrippedGoal extends MoveToBlockGoal {
        ...
        public DeerStrippedGoal(double pSpeedModifier, int pSearchRange, int pVerticalSearchRange) {
            super(MiniHipo.this, pSpeedModifier, pSearchRange, pVerticalSearchRange);
        }
        ...
        public void tick() {
            ...
            } else if (!this.isReachedTarget() && MiniHipo.this.random.nextFloat() < 0.05F) {
                MiniHipo.this.playSound(SoundEvents.HORSE_STEP, 1.0F, 1.0F);
            }
        ...
        private void stripped(BlockState pState , BlockPos pos) {
            int j = 1 + MiniHipo.this.level().random.nextInt(2);
            ItemStack itemstack = MiniHipo.this.getItemBySlot(EquipmentSlot.MAINHAND);
            if (itemstack.isEmpty()) {
                MiniHipo.this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(Items.MELON_SLICE));
                --j;
            }

            if (j > 0) {
                Block.popResource(MiniHipo.this.level(), this.blockPos, new ItemStack(Items.MELON_SLICE, j*10));
            }

            MiniHipo.this.playSound(SoundEvents.AXE_STRIP, 1.0F, 1.0F);
            MiniHipo.this.level().setBlock(pos, Blocks.AIR.defaultBlockState(),11);
        }

        public boolean canUse() {
            return !MiniHipo.this.isSleeping() && super.canUse();
        }
