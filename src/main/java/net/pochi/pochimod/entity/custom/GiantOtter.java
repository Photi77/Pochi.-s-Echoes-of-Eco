...
public class GiantOtter extends Turtle{

    public final net.minecraft.world.entity.AnimationState idleAnimationState = new AnimationState();
    private int idleAnimationTimeout = 0;
    public GiantOtter(EntityType<? extends Turtle> p_28316_, Level p_28317_) {
        super(p_28316_, p_28317_);
        this.moveControl = new GiantOtter.TurtleMoveControl(this);
    }

    private static final EntityDataAccessor<BlockPos> TRAVEL_POS = SynchedEntityData.defineId(GiantOtter.class, EntityDataSerializers.BLOCK_POS);
    ...
    private static final EntityDataAccessor<Boolean> TRAVELLING = SynchedEntityData.defineId(GiantOtter.class, EntityDataSerializers.BOOLEAN);
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, Guardian.class, false));
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, Drowned.class, false));
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_146743_, AgeableMob p_146744_) {
        return ModEntityTypes.GIANT_OTTER.get().create(p_146743_, net.minecraft.world.entity.EntitySpawnReason.MOB_SUMMONED);
    }
    ...
    static class TurtleTravelGoal extends Goal {
        private final GiantOtter turtle;
        private final double speedModifier;
        private boolean stuck;

        TurtleTravelGoal(GiantOtter p_30333_, double p_30334_) {
