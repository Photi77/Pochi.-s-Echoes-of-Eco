...
public class HarpyEagle extends Animal implements FlyingAnimal {
    ...
    public HarpyEagle(EntityType<? extends Animal> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        //this.goalSelector.addGoal(2,new HarpyEagle.HarpyEagleAttackPlayerTargetGoal());
        this.goalSelector.addGoal(2, new Peacock.SparrowWanderGoal(this, 1.5D));
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_146743_, AgeableMob p_146744_) {
        return ModEntityTypes.HARPY_EAGLE.get().create(p_146743_, net.minecraft.world.entity.EntitySpawnReason.MOB_SUMMONED);
    }
