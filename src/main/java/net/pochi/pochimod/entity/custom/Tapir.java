...
public class Tapir extends Animal {
    ...
    public Tapir(EntityType<? extends Animal> p_27557_, Level p_27558_) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_146743_, AgeableMob p_146744_) {
        return ModEntityTypes.TAPIR.get().create(p_146743_, net.minecraft.world.entity.EntitySpawnReason.MOB_SUMMONED);
    }
    ...
    public InteractionResult mobInteract(Player p_27584_, InteractionHand p_27585_) {
        if(p_27584_.getMainHandItem().is(ModItems.PEACH.get())) {
            p_27584_.getMainHandItem().shrink(1);
            p_27584_.addEffect(new MobEffectInstance(ModEffects.DREAMER,36000));
            Dreamer.setPos(p_27584_.getOnPos());
            Dreamer.setDimensionKey(p_27584_.level().dimension());
        }
