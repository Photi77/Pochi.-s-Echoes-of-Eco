...
public class RockPenguinArmor extends Item implements GeoItem {
    ...
    public RockPenguinArmor(Holder<ArmorMaterial> p_40386_, ArmorType p_266831_, Properties p_40388_) {
        super(p_40388_);
    }
    ...
    public void onArmorTick(ItemStack stack, Level level, Player player) {
        if(!level.isClientSide()) {
            player.addEffect(new MobEffectInstance(MobEffects.JUMP_BOOST,40,4));
