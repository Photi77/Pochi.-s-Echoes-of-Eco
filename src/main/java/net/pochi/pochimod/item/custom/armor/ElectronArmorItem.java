...
public class ElectronArmorItem extends Item {
    public ElectronArmorItem(Holder<ArmorMaterial> p_40386_, ArmorType p_266831_, Properties p_40388_) {
        super(p_40388_);
    }
    ...
    private boolean hasFullSuitOfArmorOn(Player player) {
        ...
        boolean leggings = player.getItemBySlot(net.minecraft.world.entity.EquipmentSlot.LEGS).is(ModItems.ELECTRON_LEGGINGS.get());
        boolean chestplate = player.getItemBySlot(net.minecraft.world.entity.EquipmentSlot.CHEST).is(ModItems.ELECTRON_CHESTPLATE.get());
        boolean helmet = player.getItemBySlot(net.minecraft.world.entity.EquipmentSlot.HEAD).is(ModItems.ELECTRON_HELMET.get());
