...
public class HammerHeadPickaxe extends Item {
    public HammerHeadPickaxe(Properties p_42964_) {
        super(p_42964_);
    }
            ...
            for(int y = -50;y <= 50;y++){
                for(int z = -50;z <= 50;z++){
                    ...
                    if(p_41432_.getBlockState(pos).is(Blocks.DIAMOND_ORE) || p_41432_.getBlockState(pos).is(Blocks.DEEPSLATE_DIAMOND_ORE)){
                        OreSlime dirtGolem = ModEntityTypes.ORE_SEARCH.get().create(p_41432_, net.minecraft.world.entity.EntitySpawnReason.MOB_SUMMONED);
                        dirtGolem.absSnapTo(pos.getX()+0.5, pos.getY(), pos.getZ()+0.5);
