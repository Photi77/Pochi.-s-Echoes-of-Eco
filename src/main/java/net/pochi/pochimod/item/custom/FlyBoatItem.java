...
public class FlyBoatItem extends Item {
    ...
    public FlyBoatItem(Properties pProperties) {
        super(pProperties);
    ...
    private Boat getBoat(Level p_220017_, HitResult p_220018_) {
        return (Boat) new FlyingBoatEntity(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z);
    }
}
