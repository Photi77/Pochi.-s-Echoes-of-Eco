...
public class FrypanMenu extends AbstractContainerMenu {
    private final FrypanBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public FrypanMenu(int windowId, Inventory inv, FriendlyByteBuf extraData) {
        this(windowId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public FrypanMenu(int windowId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.FRYPAN_MENU.get(), windowId);
        checkContainerSize(inv, 10);
        blockEntity = ((FrypanBlockEntity) entity);
        ...
        this.addSlot(new ModResultSlot(handler, 9, 125, 35));
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.FRYPAN_BLOCK.get());
    }
