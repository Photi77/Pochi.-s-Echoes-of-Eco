...
import net.pochi.pochimod.block.entity.custom.MixerBlockEntity;
...
public class MixerMenu extends AbstractContainerMenu {
    ...
    public MixerMenu(int windowId, Inventory inv, FriendlyByteBuf extraData) {
        this(windowId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public MixerMenu(int windowId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.MIXER_MENU.get(), windowId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.MIXER_BLOCK.get());
    }
