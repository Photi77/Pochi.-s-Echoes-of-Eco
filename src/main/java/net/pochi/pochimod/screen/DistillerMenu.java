...
import net.pochi.pochimod.block.entity.custom.DistillerBlockEntity;
...
public class DistillerMenu extends AbstractContainerMenu {
    ...
    public DistillerMenu(int windowId, Inventory inv, FriendlyByteBuf extraData) {
        this(windowId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public DistillerMenu(int windowId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.DISTILLER_MENU.get(), windowId);
        ...
        this.addSlot(new ModResultSlot(handler, 4, 120, 35));
